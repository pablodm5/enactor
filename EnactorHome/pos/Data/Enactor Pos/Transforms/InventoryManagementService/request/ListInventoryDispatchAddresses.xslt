...
<!--  ListInventoryDispatchAddresses operation local request to central request -->
...
<xsl:template match="ns:listInventoryDispatchAddresses">
	<ns:listInventoryDispatchAddresses>	
		<xsl:apply-templates select="*"/>
	</ns:listInventoryDispatchAddresses>	
</xsl:template>

<xsl:template match="retail:localListInventoryDispatchAddressesRequest">
	<retail:listInventoryDispatchAddressesRequest>
		<xsl:apply-templates select="*"/>
	</retail:listInventoryDispatchAddressesRequest>
</xsl:template>
