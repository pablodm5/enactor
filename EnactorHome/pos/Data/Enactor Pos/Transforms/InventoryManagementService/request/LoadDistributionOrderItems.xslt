...
<!--  LoadDistributionOrderItems operation local request to central request -->
...
<xsl:template match="ns:loadDistributionOrderItems">
	<ns:loadDistributionOrderItems>	
		<xsl:apply-templates select="*"/>
	</ns:loadDistributionOrderItems>	
</xsl:template>

<xsl:template match="retail:localLoadDistributionOrderItemsRequest">
	<retail:loadDistributionOrderItemsRequest>
		<xsl:apply-templates select="*"/>
	</retail:loadDistributionOrderItemsRequest>
</xsl:template>
