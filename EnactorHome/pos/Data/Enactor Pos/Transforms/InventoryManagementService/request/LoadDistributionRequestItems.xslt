...
<!--  LoadDistributionRequestItems operation local request to central request -->
...
<xsl:template match="ns:loadDistributionRequestItems">
	<ns:loadDistributionRequestItems>	
		<xsl:apply-templates select="*"/>
	</ns:loadDistributionRequestItems>	
</xsl:template>

<xsl:template match="retail:localLoadDistributionRequestItemsRequest">
	<retail:loadDistributionRequestItemsRequest>
		<xsl:apply-templates select="*"/>
	</retail:loadDistributionRequestItemsRequest>
</xsl:template>

<xsl:template match="retail:distributionRequestId"> 
