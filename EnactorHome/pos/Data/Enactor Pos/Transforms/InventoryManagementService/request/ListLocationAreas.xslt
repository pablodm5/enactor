...
<!--  ListLocationAreas operation local request to central request -->
...
<xsl:template match="ns:listLocationAreas">
	<ns:listLocationAreas>	
		<xsl:apply-templates select="*"/>
	</ns:listLocationAreas>	
</xsl:template>

<xsl:template match="retail:localListLocationAreasRequest">
	<retail:listLocationAreasRequest>
		<xsl:apply-templates select="*"/>
	</retail:listLocationAreasRequest>
</xsl:template>
