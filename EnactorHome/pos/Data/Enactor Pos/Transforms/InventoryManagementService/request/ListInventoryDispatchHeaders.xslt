...
<!--  ListInventoryDispatchHeaders operation local request to central request -->
...
<xsl:template match="ns:listInventoryDispatchHeaders">
	<ns:listInventoryDispatchHeaders>	
		<xsl:apply-templates select="*"/>
	</ns:listInventoryDispatchHeaders>	
</xsl:template>

<xsl:template match="retail:localListInventoryDispatchHeadersRequest">
	<retail:listInventoryDispatchHeadersRequest>
		<xsl:apply-templates select="*"/>
	</retail:listInventoryDispatchHeadersRequest>
</xsl:template>
