...
<!--  ListExpectedDeliveryHeaders operation local request to central request -->
...
<xsl:template match="ns:listExpectedDeliveryHeaders">
	<ns:listExpectedDeliveryHeaders>	
		<xsl:apply-templates select="*"/>
	</ns:listExpectedDeliveryHeaders>	
</xsl:template>

<xsl:template match="retail:localListExpectedDeliveryHeadersRequest">
	<retail:listExpectedDeliveryHeadersRequest>
		<xsl:apply-templates select="*"/>
	</retail:listExpectedDeliveryHeadersRequest>
</xsl:template>
