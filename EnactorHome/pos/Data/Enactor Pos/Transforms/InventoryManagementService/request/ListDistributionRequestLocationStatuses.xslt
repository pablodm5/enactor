...
<!--  ListDistributionRequestLocationStatuses operation local request to central request -->
...
<xsl:template match="ns:listDistributionRequestLocationStatuses">
	<ns:listDistributionRequestLocationStatuses>	
		<xsl:apply-templates select="*"/>
	</ns:listDistributionRequestLocationStatuses>	
</xsl:template>

<xsl:template match="retail:localListDistributionRequestLocationStatusesRequest">
	<retail:listDistributionRequestLocationStatusesRequest>
		<xsl:apply-templates select="*"/>
	</retail:listDistributionRequestLocationStatusesRequest>
</xsl:template>
