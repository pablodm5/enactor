...
<!--  ListAdvanceShippingNoticeHeaders operation local request to central request -->
...
<xsl:template match="ns:listAdvanceShippingNoticeHeaders">
	<ns:listAdvanceShippingNoticeHeaders>	
		<xsl:apply-templates select="*"/>
	</ns:listAdvanceShippingNoticeHeaders>	
</xsl:template>

<xsl:template match="retail:localListAdvanceShippingNoticeHeadersRequest">
	<retail:listAdvanceShippingNoticeHeadersRequest>
		<xsl:apply-templates select="*"/>
	</retail:listAdvanceShippingNoticeHeadersRequest>
</xsl:template>

<xsl:template match="retail:destinationLocationId"> 
