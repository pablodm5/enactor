...
<!--  ValidateSerialNumber operation local request to central request -->
...
<xsl:template match="ns:validateSerialNumber">
	<ns:validateSerialNumber>	
		<xsl:apply-templates select="*"/>
	</ns:validateSerialNumber>	
</xsl:template>

<xsl:template match="retail:localValidateSerialNumberRequest">
	<retail:validateSerialNumberRequest>
		<xsl:copy-of select="*">
		</xsl:copy-of>
	</retail:validateSerialNumberRequest>
</xsl:template>
