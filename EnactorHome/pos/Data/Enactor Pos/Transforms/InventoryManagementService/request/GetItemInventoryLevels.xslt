...
<!--  GetItemInventoryLevels operation local request to central request -->
...
<xsl:template match="ns:getInventoryLevels">
	<ns:getInventoryLevels>	
		<xsl:apply-templates select="*"/>
	</ns:getInventoryLevels>	
</xsl:template>

<xsl:template match="retail:localGetInventoryLevelsRequest">
	<retail:getInventoryLevelsRequest>
		<xsl:copy-of select="*">
		</xsl:copy-of>
	</retail:getInventoryLevelsRequest>
</xsl:template>
