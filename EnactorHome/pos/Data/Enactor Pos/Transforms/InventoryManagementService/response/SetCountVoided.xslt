...
<!--  Enactor SetCountVoided entities -->
...
<xsl:template match="ns:setCountVoidedResponse">
	<ns:listSetCountVoidedResponse>
		<xsl:apply-templates select="*"/>
	</ns:listSetCountVoidedResponse>
</xsl:template>

<xsl:template match="retail:setCountVoidedResponse">
	<retail:localSetCountVoidedResponse>
		<xsl:apply-templates select="*"/>
	</retail:localSetCountVoidedResponse>
</xsl:template>
