...
<xsl:template match="ns:listInventoryDispatchHeadersResponse">
	<ns:listInventoryDispatchHeadersResponse>
		<xsl:apply-templates select="*"/>
	</ns:listInventoryDispatchHeadersResponse>
</xsl:template>

<xsl:template match="retail:listInventoryDispatchHeadersResponse">
	<retail:localListInventoryDispatchHeadersResponse>
		<xsl:apply-templates select="*"/>
	</retail:localListInventoryDispatchHeadersResponse>
</xsl:template>

<xsl:template match="retail:inventoryDispatchHeadersList">
	<retail:expectedTransferHeadersList>
		<xsl:apply-templates select="*" mode="inventoryDispatchHeader"/>
	</retail:expectedTransferHeadersList>
</xsl:template>

<xsl:template match="retail:inventoryDispatchHeader" mode="inventoryDispatchHeader">
...
<xsl:template match="retail:distributionOrderKey" mode="inventoryDispatchHeader"> 
...
<xsl:template match="retail:dispatchStatus" mode="inventoryDispatchHeader"> 
...
<xsl:template match="retail:totalDispatchedUnits" mode="inventoryDispatchHeader"> 
