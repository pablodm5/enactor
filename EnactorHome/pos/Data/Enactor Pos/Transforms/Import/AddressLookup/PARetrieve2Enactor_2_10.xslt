...
>
	...
	<xsl:template match="pa:CapturePlus_Interactive_Retrieve_v2_10_Response/pa:CapturePlus_Interactive_Retrieve_v2_10_Result/pa:CapturePlus_Interactive_Retrieve_v2_10_Results" >
	<retail:address>
		...
		<retail:countryCodeId><xsl:value-of select="pa:CountryIso2"/></retail:countryCodeId> 
	</retail:address>
	</xsl:template>
