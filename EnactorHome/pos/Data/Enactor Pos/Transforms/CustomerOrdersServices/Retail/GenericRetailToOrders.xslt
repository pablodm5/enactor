<xsl:stylesheet version="1.0"
	...
	<xsl:template match="retail:customerOrderCreateHeaderMessage">
		<orders:customerOrderCreateHeaderMessage>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:customerOrderUpdateHeaderMessage">
		<orders:customerOrderUpdateHeaderMessage>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:customerOrderCreateItemMessage">
		<orders:customerOrderCreateItemMessage>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:customerOrderUpdateItemMessage">
		<orders:customerOrderUpdateItemMessage>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:repairOrderCreateHeaderMessage">
		<orders:repairOrderCreateHeaderMessage>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:repairOrderCreateItemMessage">
		<orders:repairOrderCreateItemMessage>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:updateDestinationTransaction">
		<orders:updateDestinationTransaction>
			<xsl:copy-of select="@*"/>
	...
	<xsl:template match="retail:destination[ancestor::retail:updateDestinationTransaction]">
	...
	<xsl:template match="retail:giftCardPayment">
		<orders:giftCardPayment>
			<xsl:copy-of select="@*"/>		
			<xsl:apply-templates select="*" mode="giftCardPayment"/>
		</orders:giftCardPayment>
	</xsl:template>
	...
	<xsl:template match="retail:giftCardDetails" mode="giftCardPayment">
		<orders:giftCardDetails>
			<xsl:copy-of select="@*"/>
			<xsl:apply-templates mode="retail" />
		</orders:giftCardDetails>
	</xsl:template>

	<xsl:template match="retail:tenderId" mode="giftCardPayment">
		<orders:tenderId>
			<xsl:copy-of select="@*"/>			
			<xsl:apply-templates mode="retail" />
		</orders:tenderId>
	...
	<xsl:template match="retail:isRefund" mode="giftCardPayment">
		<orders:isRefund>
			<xsl:copy-of select="@*"/>		
			<xsl:apply-templates mode="retail" />
		</orders:isRefund>
	...
	<xsl:template match="retail:*" mode="giftCardPayment" priority="-1">
		<xsl:element name="orders:{local-name()}" namespace="http://www.enactor.com/orders">
			<xsl:apply-templates select="@*"/>
			<xsl:apply-templates />
		</xsl:element>
	...
	<xsl:template match="retail:depositDetail">
		<retail:depositDetail>			
			<xsl:apply-templates select="*" mode="retail" />
		</retail:depositDetail>
	</xsl:template>
